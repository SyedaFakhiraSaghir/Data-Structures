...
class User{
	...
	public:
		...
		{
			l[0].head=us.l[0].head;
			l[1].head=us.l[1].head;
			l[2].head=us.l[2].head;
			l[3].head=us.l[3].head;
			l[4].head=us.l[4].head;
			l[5].head=us.l[5].head;
			l[6].head=us.l[6].head;
			return *this;
		}
...
{
    ofstream file1;
    file1.open("user_data.bin", ios::binary | ios::app);
...
User ReadUserFromFile() 
{
    ...
    User uss;
    ifstream file2;
    file2.open("user_data.bin", ios::binary);
    if (file2.is_open()) 
    {
