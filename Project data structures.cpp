...
class task{
    ...
    private:
        ...
        string status; //partially done //done //not done
    ...
    public:
        ...
        task(string n,string d, string s, string c, int k, int t, bool m)
        {
            name=n;
            deadline=d;
            status=s;
...
class list{
    ...
    void sortcategory() //sorting according to category
    {
    	string cat;
    	cout<<"Press:\n";
		cout<<"1 if you want to tasks with more details on the top\n";
		cout<<"2 if you want to tasks with less details on the top\n";
...
class User{
	...
	public:
		//an array of lists as user has 6 lists
		list *l[6];
		//L [0]=academic
		//L [1]=shopping 
		//L [2]=personal
